...
import com.qa.opencart.execption.ElemenentException;
...
public class ElementUtil {
	...
	private void nullBlankCheck(String value) {
		if (value == null || value.length() == 0) {
			throw new ElemenentException(value + " --- value text can not be null or blank");
		}
	}
	...
	public void doSelectByVisibleText(By locator, String visibleText) {
		...
		try {
			...
			e.printStackTrace();
			throw new ElemenentException("text not present");
		}
	...
	public WebElement retryingElement(By locator, int timeOut) {
		...
		if(element == null) {
			...
			throw new ElemenentException("No Such Element");
		}
		return element;
